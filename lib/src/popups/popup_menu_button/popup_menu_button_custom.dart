...
/// dismissed.
///
/// Used by [PopupMenuButtonCustom.onSelected].
typedef PopupMenuItemSelected<T> = void Function(T value);

/// Signature for the callback invoked when a [PopupMenuButtonCustom] is dismissed
/// without selecting an item.
///
/// Used by [PopupMenuButtonCustom.onCanceled].
typedef PopupMenuCanceled = void Function();

/// Signature used by [PopupMenuButtonCustom] to lazily construct the items shown when
/// the button is pressed.
///
/// Used by [PopupMenuButtonCustom.itemBuilder].
...
/// then [PopupMenuButtonCustom] behaves like an [IconButton].
///
...
class PopupMenuButtonCustom<T> extends StatefulWidget {
  ...
  ///
  @override
  PopupMenuButtonCustomState<T> createState() => PopupMenuButtonCustomState<T>();
}

/// The [State] for a [PopupMenuButtonCustom].
///
/// See [showButtonMenu] for a way to programmatically open the popup menu
/// of your button state.
class PopupMenuButtonCustomState<T> extends State<PopupMenuButtonCustom<T>> {
  /// A method to show a popup menu with the items supplied to
  /// [PopupMenuButtonCustom.itemBuilder] at the position of your [PopupMenuButtonCustom].
  ///
  /// By default, it is called when the user taps the button and [PopupMenuButtonCustom.enabled]
  /// is set to `true`. Moreover, you can open the button by calling the method manually.
  ///
  /// You would access your [PopupMenuButtonCustomState] using a [GlobalKey] and
